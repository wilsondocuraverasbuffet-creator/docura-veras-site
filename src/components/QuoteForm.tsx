...
const initial = { name: '', company: '', city: '', date: '', time: '', guests: '', type: window.location.pathname.includes('coffee-break') ? 'Coffee Break Corporativo' : window.location.pathname.includes('eventos-esportivos') ? 'Evento Esportivo' : window.location.pathname.includes('catering-corporativo') ? 'Catering Corporativo' : window.location.pathname.includes('eventos-corporativos') ? 'Evento Corporativo' : '', dietary: '', notes: '' };
