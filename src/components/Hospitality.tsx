const services = [
  ...
  { number: '04', title: 'Eventos Sociais', text: 'Hospitalidade personalizada para celebrações, encontros privados e ocasiões especiais.', image: '/images/service-eventos-sociais.jpg' },
];

export function Hospitality() {
  return (
    <section id="hospitalidade" className="hospitality section-dark">
      <div className="page-width section-heading light-heading">
        <div><p className="eyebrow light">Nossa hospitalidade</p><h2>Experiências pensadas para cada ocasião.</h2></div>
