  ...
  return (
    <footer className="footer">
      <div className="footer-main page-width">
        ...
        <div className="footer-nav"><strong>Serviços</strong><a href="/coffee-break">Coffee Break</a><a href="/#catering">Eventos Esportivos</a><a href="/#catering">Catering Corporativo</a><a href="/#catering">Eventos Corporativos</a></div>
