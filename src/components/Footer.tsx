  ...
  return (
    <footer className="footer">
      <div className="footer-main page-width">
        ...
        <div className="footer-nav"><strong>Serviços</strong><a href="/coffee-break">Coffee Break</a><a href="/eventos-esportivos">Eventos Esportivos</a><a href="/catering-corporativo">Catering Corporativo</a><a href="/#catering">Eventos Corporativos</a></div>
